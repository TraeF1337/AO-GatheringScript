...
{
    public class RPFirstState : StateScript
    {
        private Configuration config;
        private Context context;

        public RPFirstState(Configuration config, Context context)
        {
            this.config = config;
        ...
        public override int OnLoop(IScriptEngine se)
        {
            ...
            if (Players.LocalPlayer.HealthPercentage > 50)
            {
                Players.LocalPlayer.ToggleMount(true);
            }
